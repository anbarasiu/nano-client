    ...
    return (
        <div className="about py-4">
            <div className="text-center">
                <h5 className="font-weight-bold">More than 60k jobs are posted on Nano every week</h5>
            </div>
